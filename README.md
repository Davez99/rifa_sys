...
✅ Próximos Passos
Criar Google Apps Script (backend)

Criar HTML + JS para consumir os dados e interagir com a planilha📋 Sistema de Rifas com Google Apps Script + HTML/CSS/JS
💡 Escopo
1. Cadastro de nova rifa (via planilha/admin)
Nome da rifa
...
Criar HTML + JS para consumir os dados e interagir com a planilha